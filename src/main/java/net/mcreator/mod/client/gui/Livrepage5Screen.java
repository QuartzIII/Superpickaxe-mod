...
public class Livrepage5Screen extends AbstractContainerScreen<Livrepage5Menu> {
	private final static HashMap<String, Object> guistate = Livrepage5Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Livrepage5Screen(Livrepage5Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mod:textures/screens/livrepage_5.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Table de", 85, 76, -12829636);
		this.font.draw(poseStack, "forgeron", 85, 86, -12829636);
	}
