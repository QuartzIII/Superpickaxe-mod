...
public class Livrepage6Screen extends AbstractContainerScreen<Livrepage6Menu> {
	private final static HashMap<String, Object> guistate = Livrepage6Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Livrepage6Screen(Livrepage6Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mod:textures/screens/livrepage_6.png");
