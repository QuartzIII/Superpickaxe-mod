...
import net.mcreator.mod.network.Livrepage4ButtonMessage;
...
public class Livrepage4Screen extends AbstractContainerScreen<Livrepage4Menu> {
	private final static HashMap<String, Object> guistate = Livrepage4Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Livrepage4Screen(Livrepage4Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mod:textures/screens/livrepage_4.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 192, this.topPos + 128, 15, 20, new TextComponent("->"), e -> {
			if (true) {
				ModMod.PACKET_HANDLER.sendToServer(new Livrepage4ButtonMessage(0, x, y, z));
				Livrepage4ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
