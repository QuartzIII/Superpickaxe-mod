...
public class Upgradespeed1Item extends Item {
	public Upgradespeed1Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Pour augmenter la puissance de l'ultime superpickaxe au niveau 1"));
	}
}
